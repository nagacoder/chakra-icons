const updateRootReadmeTemplate =
  ...
  " | ✅  | [![@chakra-icons/{{name}} version](https://badgen.net/npm/v/@chakra-icons/{{name}}.svg?color=green)](https://www.npmjs.com/package/@chakra-icons/{{name}})" +
  " [![@chakra-icons/{{name}} treeshakeble](https://badgen.net/bundlephobia/tree-shaking/@chakra-icons/{{name}}.svg?color=blue)](https://www.npmjs.com/package/@chakra-icons/{{name}})" +
